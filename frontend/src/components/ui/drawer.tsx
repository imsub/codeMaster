    ...
    <DrawerPortal data-slot="drawer-portal">
      ...
      <DrawerPrimitive.Content
        ...
        className={cn(
          ...
          "data-[vaul-drawer-direction=right]:tw-inset-y-0 data-[vaul-drawer-direction=right]:tw-right-0 data-[vaul-drawer-direction=right]:tw-w-3/4 data-[vaul-drawer-direction=right]:tw-border-l data-[vaul-drawer-direction=right]:sm:tw-max-w-sm",
          "data-[vaul-drawer-direction=left]:tw-inset-y-0 data-[vaul-drawer-direction=left]:tw-left-0 data-[vaul-drawer-direction=left]:tw-w-3/4 data-[vaul-drawer-direction=left]:tw-border-r data-[vaul-drawer-direction=left]:sm:tw-max-w-sm",
          className
        )}
        {...props}
      >
