  ...
  return (
    <ChartContext.Provider value={{ config }}>
      <div
        ...
        data-chart={chartId}
        className={cn(
          "[&_.recharts-cartesian-axis-tick_text]:tw-fill-muted-foreground [&_.recharts-cartesian-grid_line[stroke=#ccc]]:tw-stroke-border/50 [&_.recharts-curve.recharts-tooltip-cursor]:tw-stroke-border [&_.recharts-polar-grid_[stroke=#ccc]]:tw-stroke-border [&_.recharts-radial-bar-background-sector]:tw-fill-muted [&_.recharts-rectangle.recharts-tooltip-cursor]:tw-fill-muted [&_.recharts-reference-line_[stroke=#ccc]]:tw-stroke-border tw-flex tw-aspect-video tw-justify-center tw-text-xs [&_.recharts-dot[stroke=#fff]]:tw-stroke-transparent [&_.recharts-layer]:tw-outline-hidden [&_.recharts-sector]:tw-outline-hidden [&_.recharts-sector[stroke=#fff]]:tw-stroke-transparent [&_.recharts-surface]:tw-outline-hidden",
          className
        )}
        {...props}
      >
        ...
        {payload.map((item, index) => {
          ...
          return (
            <div
              key={item.dataKey}
              className={cn(
                "[&>svg]:tw-text-muted-foreground tw-flex tw-w-full tw-flex-wrap tw-items-stretch tw-gap-2 [&>svg]:tw-h-2.5 [&>svg]:tw-w-2.5",
      ...
      {payload.map((item) => {
        ...
        return (
          <div
            key={item.value}
            className={cn(
              "[&>svg]:tw-text-muted-foreground tw-flex tw-items-center tw-gap-1.5 [&>svg]:tw-h-3 [&>svg]:tw-w-3"
            )}
          >
